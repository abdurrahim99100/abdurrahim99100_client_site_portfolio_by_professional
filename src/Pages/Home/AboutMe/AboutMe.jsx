        ...
        <div id="about">
            <div className="h-auto lg:h-[100vh] px-5 lg:container lg:mx-auto flex flex-col justify-center items-center">
                <div data-aos="zoom-in"
                    ...
                    className="flex flex-col items-center font-semibold text-4xl mb-2">
                    <h3>About Me</h3>
                ...
                <div className="mt-5 flex-none lg:flex lg:justify-center lg:gap-5">
                    ...
                    <div data-aos="zoom-in-left"
                        ...
                        <a className="w-[290px] p-0 mt-5 text-xl rounded flex items-center gap-2 text-[#15E0B7] border-2 border-[#15E0B7] uppercase btn bg-[#18172b]" href="resume-of-abdurrahim.pdf" download><span>downloads resume</span> <FaDownload /> </a>
                    </div>
                </div>
            </div>
        </div>
